...
if (isset($_POST['masuk'])) {
 ...
 if (empty($nama_user) || empty($email) || empty($password) || empty($nik)) {
    $error = "Silakan lengkapi semua field!";
} else {
    // Melakukan koneksi ke database
    $conn = mysqli_connect("localhost", "root", "", "tickyt");
    if (!$conn) {
    ...
    // Melakukan query untuk memasukkan data ke tabel customer
    $query = "INSERT INTO customer (customer_name, email, password, nik) VALUES ('$nama_user', '$email', '$password', '$nik')";
    if (mysqli_query($conn, $query)) {
        // Data berhasil dimasukkan, redirect ke halaman sukses
        ...
        <div class="card-body">
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="user" class="form-control" id="exampleInputUser1" placeholder="Masukan Nama User">
                </div><br>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nik" class="form-control" id="exampleInputNIK1" placeholder="Masukan NIK">
                </div><br>

                <button type="submit" name="masuk" class="btn btn-danger">Regist</button>
            </form>
        </div>
    </div>
        </div>
