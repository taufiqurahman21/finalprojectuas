...
if (isset($_POST['masuk'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        // Data login benar, redirect ke halaman selanjutnya
        ...
        <div class="card-body">
            ...
            <form method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control" id="exampleInputEmail1" placeholder="Masukan Username">
                </div> <br>
                ...
                <button type="submit" name="masuk" class="btn btn-danger">Login</button> 
                <button type="submit" name="regis" class="btn btn-secondary">Registrasi</button>
            </form>
        </div>
    </div>
        </div>
