                ...
                <div class="col-md-12 col-lg-8">
                    <div class="detail-event">
                        <div class="event-banner">
                            <img src="img/afgankonser.png" alt="">
                        </div>
                        <div class="category">
                            ...
                            <div class="detail-info">
                                <div class="creator">
                                    ...
                                    <div class="creator-name">
                                        ...
                                        <span>TRINITIY ENTERTAINMENT</span>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-desc" role="tabpanel" aria-labelledby="pills-desc-tab" tabindex="0">
                                    ...
                                    <div class="description-text">
                                        <p>Afgan Evolution merupkan sebuah festival musik yang akan digelar pada hari Sabtu, 1 Juli 2023, di Gelora Bung Karno, Jakarta. Awal mula "Evolution" tercetus sebagai tajuk konser, karena setiap lagu yang ia buat  selalu mewakili chapter tertentu dalam hidupnya. Sehingga ia menginginkan orang-orang lebih mengenal karya-karyanya.</p>
                                    </div>
                                    <div class="description-label">
