                ...
                <div class="col-md-12 col-lg-8">
                    <div class="detail-event">
                        <div class="event-banner">
                            <img src="img/sodvestifal.webp" alt="">
                        </div>
                        <div class="category">
                            ...
                            <div class="detail-info">
                                ...
                                <div class="location">
                                    ...
                                    <div class="location-text">
                                        ...
                                        <span><a class="link-location">Lapangan Bhumi Marinir Karang Pilang, Surabaya</a></span>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-desc" role="tabpanel" aria-labelledby="pills-desc-tab" tabindex="0">
                                    ...
                                    <div class="description-text">
                                        <p>Sounds of Downtown (SoD) adalah sebuah festival musik kolaboratif yang diselenggarakan oleh PT. Serikat Orang Dalam, sebuah perusahaan yang berfokus pada musik, hiburan, dan industri kreatif lainnya.

Acara ini akan diselenggarakan pada Sabtu & Minggu, 5-6 Agustus 2022 di Lapangan Bhumi Marinir Sutedi Senaputra Karang Pilang, Surabaya, dengan menampilkan musisi ternama tanah air, mulai dari D’Masiv, Armada, Yura, Nadin Amizah, dan banyak lagi yang akan segera diumumkan!</p>
                                    </div>
                                    <div class="description-label">
                                    ...
                                    <div class="card-tiket">
                                        ...
                                        <div class="ticket-order">
                                            ...
                                            <a href="order.php" class="btn-buy">pilih</a> 
                                                                        ...
                                                                        <input type="hidden" id="cart_id_6488633bf3811" name="cart_id" value="CRT-6488633bf30f020230613123819">
                                    <input type="hidden" id="cart_qty_6488633bf3811" name="cart_qty" value="1">
                                    <input type="hidden" id="tkt_id_6488633bf3811" name="tkt_id" value="TKT743">
                                    <input type="hidden" id="event_id_6488633bf3811" name="event_id" value="EVN143">
