...
<section class="mt-4" id="home-banner">
        <div class="container">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                                ...
                                <a href="index.php" target="_blank">
                                    <img class="d-block mx-auto" src="img/main.png" alt="">
                                </a>
                            </li>
                                                    <li class="splide__slide">
                                <a href="event1.php" target="_blank">
                                    <img class="d-block mx-auto" src="img/jkt48.webp" alt="">
                                </a>
                            </li>
                                                    <li class="splide__slide">
                                <a href="event2.php" target="_blank">
                                    <img class="d-block mx-auto" src="img/afgankonser.png" alt="">
                                </a>
                            </li>
                                                    <li class="splide__slide">
                                <a href="event3.php" target="_blank">
                                    <img class="d-block mx-auto" src="img/sodvestifal.webp" alt="">
                                </a>
                            </li>
                                                </ul>
                    </div>
      ...
      <section class="mt-4" id="section-laris-manis">
        <div class="container laris-manis">
            <div class="row">
                <div class="col-lg-4">
                    <div class="bg-laris-manis">
                        <div class="text-laris-manis">
                            <h3>Laris Manis!</h3>
                ...
                <div class="col-lg-8">
                    <div class="card-laris-manis">
                                            <a href="tentangkami.php">
                        <div class="event-laris-manis">
                            <div class="col-5 p-0">
                                <div class="banner-laris-manis">
                                    <img src="img/aboutus.png" alt="">
                                </div>
                            </div>
                            <div class="col-7 pl-0">
                                <div class="detail-laris-manis">
                                    <div class="name-laris-manis">
                                        <h4>Tentang Kami</h4>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="my-4">
        <div class="container">
            <div class="rekomendasi-event">
                <div class="label-rekomendasi-event">
                    <h4>Rekomendasi Event</h4>
                    <!-- <a href="">Lihat lainnya</a> -->
                </div>

                <div class="row card-rekomendasi-event">
                                        <div class="col-lg-4 md-col-6">
                        <a href="event1.php">
                        <div class="card-event">
                            <div class="banner-event">
                                <img src="img/jkt48.webp" loading="lazy" alt="">
                            </div>
                            <div class="detail-event">
                                <div class="event-name">
                                    <h5>JKT48 SUMMER FESTIVAL</h5>
                                </div>
                                <div class="info-event">
                                    ...
                                    <div class="event-location">
                                        ...
                                        <label for="">Tennis Indoor Senayan, Jakarta</label>
                                    </div>
                                    <div class="event-order">
                                        ...
                                        <div class="event-buy">
                                            <button class="btn-event-buy">Beli</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-event">
                            <div class="banner-event">
                                <img src="img/afgankonser.png" loading="lazy" alt="">
                            </div>
                            <div class="detail-event">
                                <div class="event-name">
                                    <h5>Konser Afgan</h5>
                        ...
                        <div class="card-event">
                            <div class="banner-event">
                                <img src="img/sodvestifal.webp" loading="lazy" alt="">
                            </div>
                            <div class="detail-event">
                                <div class="event-name">
                                    <h5>SOD Festival</h5>
                                ...
                                <div class="info-event">
                                    <div class="event-calendar">
                                        ...
                                        <label for="">
                                            05-06 Aug 2023                                        </label>
                                    </div>
                                    <div class="event-location">
                                        <div class="location-icon">
                                            <img src="icon/location-bold.svg" alt="">
                                        </div>
                                        <label for="">Lapangan Bhumi Marinir Karang Pilang, Surabaya</label>
                                    </div>
                                    <div class="event-order">
                                        <div class="event-price">
                                            <label for="">Harga mulai</label>
            ...
            <div class="see-more mt-4">
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSdb5R5xwiwEi3KMyuI828YU42A_YHHIxQArXR9ZSfmscESwCA/viewform?usp=sf_link">
                    <button class="btn-see-more">Tambahkan Eventmu</button>
                </a>
            </div>
