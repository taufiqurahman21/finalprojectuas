...
<div id="hs_cos_wrapper_module_161020935349249" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module"><div class="about">
  <img class="w-100" src="img/tick.png">
  <!-- BREADCRUMB -->
  <div class="page-center">
    <nav aria-label="breadcrumb">
        <ol id="breadcrumb" class="breadcrumb bg-transparent"><li class="breadcrumb-item"><a href="https://www.ruangguru.com">Home</a></li><li class="breadcrumb-item active">About Us </li></ol>
    </nav>
</div>      
  <div class="page-center">
            <div class="row">
...
<!--         <div class="row">
        <div class="breadcrumb-ba"><a href="https://www.ruangguru.com/">Home</a><span>&nbsp;></span>
        <p>&nbsp;Tentang Kami</p>
        </div>
        </div> -->
            <div class="row">
                <div class="col-12">
                    <section><p>Tick Your Ticket adalah sebuah platform pemesanan tiket online yang memudahkan pengguna untuk membeli tiket konser, acara musik, pertunjukan, dan event lainnya secara praktis dan efisien. Platform ini menyediakan berbagai macam opsi tiket dari berbagai kategori dan harga untuk memenuhi kebutuhan pengguna.</i>.</p>
                  <p>Tick Your Ticket memberikan kemudahan dan kenyamanan bagi pengguna dalam membeli tiket acara secara online. Dengan berbagai fitur yang ditawarkan, pengguna dapat menjelajahi dan menikmati berbagai acara yang mereka minati dengan mudah dan aman.</p></section>
            </div>
        </div>
    </div></div>
